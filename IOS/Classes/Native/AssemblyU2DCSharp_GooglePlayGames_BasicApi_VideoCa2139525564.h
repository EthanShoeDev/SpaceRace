...
struct  VideoCaptureOverlayState_t2139525564 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(VideoCaptureOverlayState_t2139525564, ___value___1)); }
