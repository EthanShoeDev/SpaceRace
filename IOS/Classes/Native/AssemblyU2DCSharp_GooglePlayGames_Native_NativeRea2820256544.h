...
struct  AbortingRoomCreationState_t2820256544  : public State_t2818940644
{
public:
...
public:
	inline static int32_t get_offset_of_mSession_0() { return static_cast<int32_t>(offsetof(AbortingRoomCreationState_t2820256544, ___mSession_0)); }
