...
struct  VideoCaptureMode_t3658338718 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(VideoCaptureMode_t3658338718, ___value___1)); }
